...
// Parameters:
// TSoftObjectPtr<class UPaperSprite>      InIcon                                                 (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, UObjectWrapper, HasGetValueTypeHash)
...
void UWBP_UI_Widget_ToolStatus_C::Tick(const struct FGeometry& MyGeometry, float InDeltaTime)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_UI_Widget_ToolStatus_C", "Tick");

	Params::WBP_UI_Widget_ToolStatus_C_Tick Parms{};
