...
void UWBP_ServerBrowser_NavBar_Button_C::MouseClicked__DelegateSignature(int32 OutNavBarIndex)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_ServerBrowser_NavBar_Button_C", "MouseClicked__DelegateSignature");

	Params::WBP_ServerBrowser_NavBar_Button_C_MouseClicked__DelegateSignature Parms{};
