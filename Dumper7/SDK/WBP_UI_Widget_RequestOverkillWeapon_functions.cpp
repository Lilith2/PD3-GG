...
class FText UWBP_UI_Widget_RequestOverkillWeapon_C::GetCurrentOverkillName()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_UI_Widget_RequestOverkillWeapon_C", "GetCurrentOverkillName");

	Params::WBP_UI_Widget_RequestOverkillWeapon_C_GetCurrentOverkillName Parms{};
