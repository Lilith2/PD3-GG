...
public:
	...
	bool                                          CallFunc_IsAvailable_ReturnValue;                  // 0x0028(0x0001)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(sizeof(WBP_UI_Inventory_ItemSlotButton_C_OnFocused) == 0x000030, "Wrong size on WBP_UI_Inventory_ItemSlotButton_C_OnFocused");
...
static_assert(offsetof(WBP_UI_Inventory_ItemSlotButton_C_OnFocused, CallFunc_IsAvailable_ReturnValue) == 0x000028, "Member 'WBP_UI_Inventory_ItemSlotButton_C_OnFocused::CallFunc_IsAvailable_ReturnValue' has a wrong offset!");
...
public:
	...
	class USBZEquippableData*                     K2Node_DynamicCast_AsSBZEquippable_Data;           // 0x0008(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0010(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class USBZOverskillLoadoutData*               K2Node_DynamicCast_AsSBZOverskill_Loadout_Data;    // 0x0018(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_IsLockedByDLC_ReturnValue;                // 0x0149(0x0001)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals) == 0x000178, "Wrong size on WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals");
...
static_assert(offsetof(WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals, K2Node_DynamicCast_AsSBZEquippable_Data) == 0x000008, "Member 'WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals::K2Node_DynamicCast_AsSBZEquippable_Data' has a wrong offset!");
...
static_assert(offsetof(WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals, K2Node_DynamicCast_AsSBZOverskill_Loadout_Data) == 0x000018, "Member 'WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals::K2Node_DynamicCast_AsSBZOverskill_Loadout_Data' has a wrong offset!");
...
static_assert(offsetof(WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals, CallFunc_GetDisplayName_OutDisplayName) == 0x000028, "Member 'WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals::CallFunc_GetDisplayName_OutDisplayName' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals, CallFunc_GetDisplayName_OutHasText) == 0x000040, "Member 'WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals::CallFunc_GetDisplayName_OutHasText' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals, CallFunc_IsValid_ReturnValue) == 0x000041, "Member 'WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals, CallFunc_GetSkillName_ReturnValue) == 0x000048, "Member 'WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals::CallFunc_GetSkillName_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals, CallFunc_GetItemSource_ReturnValue) == 0x000060, "Member 'WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals::CallFunc_GetItemSource_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals, K2Node_MakeStruct_FormatArgumentData) == 0x000068, "Member 'WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals, K2Node_SwitchEnum_CmpSuccess) == 0x0000A8, "Member 'WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals, K2Node_MakeArray_Array) == 0x0000B0, "Member 'WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals, CallFunc_Format_ReturnValue) == 0x0000C0, "Member 'WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals, CallFunc_GetInfamyLevel_ReturnValue) == 0x0000D8, "Member 'WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals::CallFunc_GetInfamyLevel_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals, K2Node_MakeStruct_FormatArgumentData_1) == 0x0000E0, "Member 'WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals, K2Node_MakeArray_Array_1) == 0x000120, "Member 'WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals::K2Node_MakeArray_Array_1' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals, CallFunc_Format_ReturnValue_1) == 0x000130, "Member 'WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals::CallFunc_Format_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals, CallFunc_IsAvailable_ReturnValue) == 0x000148, "Member 'WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals::CallFunc_IsAvailable_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals, CallFunc_IsLockedByDLC_ReturnValue) == 0x000149, "Member 'WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals::CallFunc_IsLockedByDLC_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals, K2Node_MakeArray_Array_2) == 0x000150, "Member 'WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals::K2Node_MakeArray_Array_2' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals, CallFunc_Format_ReturnValue_2) == 0x000160, "Member 'WBP_UI_Inventory_ItemSlotButton_C_InitializeItemVisuals::CallFunc_Format_ReturnValue_2' has a wrong offset!");
