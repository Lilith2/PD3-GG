...
public:
	...
	FMulticastInlineDelegateProperty_             OnHackComplete;                                    // 0x0330(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             OnInterupted;                                      // 0x0340(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             OnResumeHack;                                      // 0x0350(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             OnStartInteraction;                                // 0x0360(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	FMulticastInlineDelegateProperty_             OnHackFailed;                                      // 0x03B8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	FMulticastInlineDelegateProperty_             OnSelectedLocation;                                // 0x0420(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)

public:
	void OnHackComplete__DelegateSignature();
	void OnInterupted__DelegateSignature();
	void OnResumeHack__DelegateSignature();
	void OnStartInteraction__DelegateSignature();
	void OnHackFailed__DelegateSignature();
	void OnSelectedLocation__DelegateSignature(int32 LocationArrayInt);
