...
public:
	...
	struct FSBZPlayerStateRemovedEvent            K2Node_Event_PlayerStateRemovedData;               // 0x0218(0x0018)(ConstParm)
	struct FSBZPlayerChatEvent                    K2Node_MakeStruct_SBZPlayerChatEvent;              // 0x0230(0x0018)()
	int32                                         CallFunc_Play2DSound_ReturnValue_7;                // 0x0248(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_24C[0x4];                                      // 0x024C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   Temp_text_Variable_1;                              // 0x0250(0x0018)()
	int32                                         CallFunc_Play2DSound_ReturnValue_8;                // 0x0268(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Temp_bool_Variable;                                // 0x026C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(WBP_UI_HUD_Chat_C_ExecuteUbergraph_WBP_UI_HUD_Chat) == 0x000288, "Wrong size on WBP_UI_HUD_Chat_C_ExecuteUbergraph_WBP_UI_HUD_Chat");
...
static_assert(offsetof(WBP_UI_HUD_Chat_C_ExecuteUbergraph_WBP_UI_HUD_Chat, K2Node_MakeStruct_SBZPlayerChatEvent) == 0x000230, "Member 'WBP_UI_HUD_Chat_C_ExecuteUbergraph_WBP_UI_HUD_Chat::K2Node_MakeStruct_SBZPlayerChatEvent' has a wrong offset!");
static_assert(offsetof(WBP_UI_HUD_Chat_C_ExecuteUbergraph_WBP_UI_HUD_Chat, CallFunc_Play2DSound_ReturnValue_7) == 0x000248, "Member 'WBP_UI_HUD_Chat_C_ExecuteUbergraph_WBP_UI_HUD_Chat::CallFunc_Play2DSound_ReturnValue_7' has a wrong offset!");
static_assert(offsetof(WBP_UI_HUD_Chat_C_ExecuteUbergraph_WBP_UI_HUD_Chat, Temp_text_Variable_1) == 0x000250, "Member 'WBP_UI_HUD_Chat_C_ExecuteUbergraph_WBP_UI_HUD_Chat::Temp_text_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_UI_HUD_Chat_C_ExecuteUbergraph_WBP_UI_HUD_Chat, CallFunc_Play2DSound_ReturnValue_8) == 0x000268, "Member 'WBP_UI_HUD_Chat_C_ExecuteUbergraph_WBP_UI_HUD_Chat::CallFunc_Play2DSound_ReturnValue_8' has a wrong offset!");
static_assert(offsetof(WBP_UI_HUD_Chat_C_ExecuteUbergraph_WBP_UI_HUD_Chat, Temp_bool_Variable) == 0x00026C, "Member 'WBP_UI_HUD_Chat_C_ExecuteUbergraph_WBP_UI_HUD_Chat::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(WBP_UI_HUD_Chat_C_ExecuteUbergraph_WBP_UI_HUD_Chat, K2Node_Select_Default) == 0x000270, "Member 'WBP_UI_HUD_Chat_C_ExecuteUbergraph_WBP_UI_HUD_Chat::K2Node_Select_Default' has a wrong offset!");
...
{
public:
	struct FSBZPlayerStateRemovedEvent            PlayerStateRemovedData;                            // 0x0000(0x0018)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};
...
static_assert(sizeof(WBP_UI_HUD_Chat_C_OnPlayerStateRemoved) == 0x000018, "Wrong size on WBP_UI_HUD_Chat_C_OnPlayerStateRemoved");
