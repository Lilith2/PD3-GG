...
struct WBP_PageCycler_C_NavigateToIndex__DelegateSignature final
{
public:
...
static_assert(alignof(WBP_PageCycler_C_NavigateToIndex__DelegateSignature) == 0x000004, "Wrong alignment on WBP_PageCycler_C_NavigateToIndex__DelegateSignature");
static_assert(sizeof(WBP_PageCycler_C_NavigateToIndex__DelegateSignature) == 0x000004, "Wrong size on WBP_PageCycler_C_NavigateToIndex__DelegateSignature");
static_assert(offsetof(WBP_PageCycler_C_NavigateToIndex__DelegateSignature, InNavigateIndex) == 0x000000, "Member 'WBP_PageCycler_C_NavigateToIndex__DelegateSignature::InNavigateIndex' has a wrong offset!");
