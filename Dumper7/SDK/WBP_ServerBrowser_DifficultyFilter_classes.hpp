...
public:
	...
	FMulticastInlineDelegateProperty_             OptionSelected;                                    // 0x0418(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	void OptionSelected__DelegateSignature(int32 SelectionIndex);
