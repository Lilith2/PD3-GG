...
void UWBP_UI_Skills_Button_C::BaseSkillEquipChanged__DelegateSignature(bool bEquipped)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_UI_Skills_Button_C", "BaseSkillEquipChanged__DelegateSignature");

	Params::WBP_UI_Skills_Button_C_BaseSkillEquipChanged__DelegateSignature Parms{};
