...
public:
	...
	bool                                          K2Node_Event_bIsEquippedNewValue;                  // 0x0010(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_11[0x3];                                       // 0x0011(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         K2Node_Event_AmmoTotalChanged;                     // 0x0014(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EPD3AmmoState                                 K2Node_Event_NewState;                             // 0x0018(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(WBP_UI_Widget_PartyMemberWeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_PartyMemberWeaponStatus, CallFunc_PlayAnimationForward_ReturnValue) == 0x000008, "Member 'WBP_UI_Widget_PartyMemberWeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_PartyMemberWeaponStatus::CallFunc_PlayAnimationForward_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_PartyMemberWeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_PartyMemberWeaponStatus, K2Node_Event_bIsEquippedNewValue) == 0x000010, "Member 'WBP_UI_Widget_PartyMemberWeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_PartyMemberWeaponStatus::K2Node_Event_bIsEquippedNewValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_PartyMemberWeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_PartyMemberWeaponStatus, K2Node_Event_AmmoTotalChanged) == 0x000014, "Member 'WBP_UI_Widget_PartyMemberWeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_PartyMemberWeaponStatus::K2Node_Event_AmmoTotalChanged' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_PartyMemberWeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_PartyMemberWeaponStatus, K2Node_Event_NewState) == 0x000018, "Member 'WBP_UI_Widget_PartyMemberWeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_PartyMemberWeaponStatus::K2Node_Event_NewState' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_PartyMemberWeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_PartyMemberWeaponStatus, K2Node_Event_AmmoAddedCount) == 0x00001C, "Member 'WBP_UI_Widget_PartyMemberWeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_PartyMemberWeaponStatus::K2Node_Event_AmmoAddedCount' has a wrong offset!");
