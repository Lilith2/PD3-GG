...
static_assert(offsetof(WBP_UI_DifficultySelectorWidget_C_ExecuteUbergraph_WBP_UI_DifficultySelectorWidget, CallFunc_Conv_IntToByte_ReturnValue) == 0x000028, "Member 'WBP_UI_DifficultySelectorWidget_C_ExecuteUbergraph_WBP_UI_DifficultySelectorWidget::CallFunc_Conv_IntToByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_DifficultySelectorWidget_C_ExecuteUbergraph_WBP_UI_DifficultySelectorWidget, CallFunc_GetValidValue_ReturnValue) == 0x000029, "Member 'WBP_UI_DifficultySelectorWidget_C_ExecuteUbergraph_WBP_UI_DifficultySelectorWidget::CallFunc_GetValidValue_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_DifficultySelectorWidget_C_ExecuteUbergraph_WBP_UI_DifficultySelectorWidget, Temp_bool_Variable_1) == 0x00002A, "Member 'WBP_UI_DifficultySelectorWidget_C_ExecuteUbergraph_WBP_UI_DifficultySelectorWidget::Temp_bool_Variable_1' has a wrong offset!");
...
static_assert(sizeof(WBP_UI_DifficultySelectorWidget_C_OnSelectionOptionChanged) == 0x000004, "Wrong size on WBP_UI_DifficultySelectorWidget_C_OnSelectionOptionChanged");
