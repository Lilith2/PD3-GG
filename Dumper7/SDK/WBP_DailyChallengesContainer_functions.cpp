...
// Function WBP_DailyChallengesContainer.WBP_DailyChallengesContainer_C.RerollUsed__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void UWBP_DailyChallengesContainer_C::RerollUsed__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_DailyChallengesContainer_C", "RerollUsed__DelegateSignature");
