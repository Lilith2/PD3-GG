...
public:
	...
	TDelegate<void(ESBZOnlineCode ErrorCode, TArray<struct FSBZNewsDataUIEntry>& NewsFeedList)> K2Node_CreateDelegate_OutputDelegate_4;            // 0x00C4(0x0014)(ZeroConstructor, NoDestructor)
