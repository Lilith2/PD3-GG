...
public:
	...
	FMulticastInlineDelegateProperty_             OnClickedEvent;                                    // 0x03A8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
