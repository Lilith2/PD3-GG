...
// Function WBP_Results_Payout.WBP_Results_Payout_C.OnPayoutFinished__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void UWBP_Results_Payout_C::OnPayoutFinished__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Results_Payout_C", "OnPayoutFinished__DelegateSignature");
...
// Parameters:
// struct FSBZEndMissionResultData         ResultData                                             (BlueprintVisible, BlueprintReadOnly, Parm)
