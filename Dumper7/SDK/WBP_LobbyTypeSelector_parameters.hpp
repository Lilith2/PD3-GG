...
static_assert(offsetof(WBP_LobbyTypeSelector_C_ExecuteUbergraph_WBP_LobbyTypeSelector, K2Node_Event_bInHasFocus) == 0x00000C, "Member 'WBP_LobbyTypeSelector_C_ExecuteUbergraph_WBP_LobbyTypeSelector::K2Node_Event_bInHasFocus' has a wrong offset!");
...
static_assert(sizeof(WBP_LobbyTypeSelector_C_OnSelectionOptionChanged) == 0x000004, "Wrong size on WBP_LobbyTypeSelector_C_OnSelectionOptionChanged");
