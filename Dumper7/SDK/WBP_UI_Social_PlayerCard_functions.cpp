...
// Parameters:
// class UWBP_UI_Social_PlayerCard_C*      ActiveContext                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_UI_Social_PlayerCard_C::ContextMenuOpened__DelegateSignature(class UWBP_UI_Social_PlayerCard_C* ActiveContext)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_UI_Social_PlayerCard_C", "ContextMenuOpened__DelegateSignature");

	Params::WBP_UI_Social_PlayerCard_C_ContextMenuOpened__DelegateSignature Parms{};

	Parms.ActiveContext = ActiveContext;
...
// Parameters:
// struct FSBZUser                         InUserEntry                                            (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
// Parameters:
// struct FSBZFriendListEntry              SBZFriendListEntry                                     (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
// struct FSBZUserActivity                 UserActivity                                           (BlueprintVisible, BlueprintReadOnly, Parm)
...
// Parameters:
// class FText                             InPlatformName                                         (BlueprintVisible, BlueprintReadOnly, Parm)
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// class FText                             InLevel                                                (BlueprintVisible, BlueprintReadOnly, Parm)
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// class FText                             PlatformName                                           (BlueprintVisible, BlueprintReadOnly, Parm)
// class FText                             NebulaName                                             (BlueprintVisible, BlueprintReadOnly, Parm)
