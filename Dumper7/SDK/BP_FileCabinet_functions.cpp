...
// Function BP_FileCabinet.BP_FileCabinet_C.PickedUpRedCard__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void ABP_FileCabinet_C::PickedUpRedCard__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_FileCabinet_C", "PickedUpRedCard__DelegateSignature");
...
// Parameters:
// class USBZBaseInteractableComponent*    InteractableComponent                                  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// Parameters:
// class USBZBaseInteractableComponent*    Key                                                    (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, InstancedReference, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
