...
// Function WBP_UI_ModeSelect_ModeButton.WBP_UI_ModeSelect_ModeButton_C.OnShowAdditionalInfo__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void UWBP_UI_ModeSelect_ModeButton_C::OnShowAdditionalInfo__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_UI_ModeSelect_ModeButton_C", "OnShowAdditionalInfo__DelegateSignature");
