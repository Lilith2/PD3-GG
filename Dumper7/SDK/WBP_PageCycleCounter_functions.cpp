...
void UWBP_PageCycleCounter_C::OnClickedItem__DelegateSignature(int32 InIndex)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PageCycleCounter_C", "OnClickedItem__DelegateSignature");

	Params::WBP_PageCycleCounter_C_OnClickedItem__DelegateSignature Parms{};
