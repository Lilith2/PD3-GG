...
void UWBP_ServerBrowser_DifficultyFilter_C::OptionSelected__DelegateSignature(int32 SelectionIndex)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_ServerBrowser_DifficultyFilter_C", "OptionSelected__DelegateSignature");

	Params::WBP_ServerBrowser_DifficultyFilter_C_OptionSelected__DelegateSignature Parms{};
...
void UWBP_ServerBrowser_DifficultyFilter_C::OnSelectionOptionChanged(int32 InCurrentIndex)
{
	static class UFunction* Func = nullptr;
