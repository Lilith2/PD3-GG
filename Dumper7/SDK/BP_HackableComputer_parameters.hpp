...
struct BP_HackableComputer_C_OnSelectedLocation__DelegateSignature final
{
public:
	int32                                         LocationArrayInt;                                  // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(BP_HackableComputer_C_OnSelectedLocation__DelegateSignature) == 0x000004, "Wrong alignment on BP_HackableComputer_C_OnSelectedLocation__DelegateSignature");
static_assert(sizeof(BP_HackableComputer_C_OnSelectedLocation__DelegateSignature) == 0x000004, "Wrong size on BP_HackableComputer_C_OnSelectedLocation__DelegateSignature");
static_assert(offsetof(BP_HackableComputer_C_OnSelectedLocation__DelegateSignature, LocationArrayInt) == 0x000000, "Member 'BP_HackableComputer_C_OnSelectedLocation__DelegateSignature::LocationArrayInt' has a wrong offset!");
