...
// Parameters:
// class USBZCosmeticsDataAsset*           InEquippedItem                                         (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
