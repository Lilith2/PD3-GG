...
public:
	...
	struct FSBZStoreItemUIData                    K2Node_Event_InUpdatedStoreItemUIData;             // 0x0470(0x00F0)(ConstParm)
	bool                                          CallFunc_IsValidSoftObjectReference_ReturnValue;   // 0x0560(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_561[0x7];                                      // 0x0561(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UImage*                                 K2Node_Select_Default_1;                           // 0x0568(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_SelectInt_ReturnValue;                    // 0x0570(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_574[0x4];                                      // 0x0574(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_Conv_Int64ToText_ReturnValue;             // 0x0578(0x0018)()
	TSoftObjectPtr<class UObject>                 K2Node_Select_Default_2;                           // 0x0590(0x0030)(HasGetValueTypeHash)
	...
	bool                                          K2Node_CustomEvent_bIsGameInstallPending;          // 0x05C8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_5C9[0x7];                                      // 0x05C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class USBZUIManager*                          CallFunc_GetUIManager_ReturnValue_4;               // 0x05D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(bool bIsGameInstallPending)>   K2Node_CreateDelegate_OutputDelegate_3;            // 0x05D8(0x0014)(ZeroConstructor, NoDestructor)
	uint8                                         Pad_5EC[0x4];                                      // 0x05EC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class USBZUIManager*                          CallFunc_GetUIManager_ReturnValue_5;               // 0x05F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsGameInstallPending_ReturnValue;         // 0x05F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_Event_bInHasFocus;                          // 0x05F9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          Temp_bool_Variable_3;                              // 0x05FA(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_5FB[0x5];                                      // 0x05FB(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   K2Node_Select_Default_3;                           // 0x0600(0x0018)()
};
...
static_assert(sizeof(WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek) == 0x000618, "Wrong size on WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek");
...
static_assert(offsetof(WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek, CallFunc_IsValidSoftObjectReference_ReturnValue) == 0x000560, "Member 'WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek::CallFunc_IsValidSoftObjectReference_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek, K2Node_Select_Default_1) == 0x000568, "Member 'WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek, CallFunc_SelectInt_ReturnValue) == 0x000570, "Member 'WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek::CallFunc_SelectInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek, CallFunc_Conv_Int64ToText_ReturnValue) == 0x000578, "Member 'WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek::CallFunc_Conv_Int64ToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek, K2Node_Select_Default_2) == 0x000590, "Member 'WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek::K2Node_Select_Default_2' has a wrong offset!");
static_assert(offsetof(WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek, CallFunc_GetDynamicMaterial_ReturnValue) == 0x0005C0, "Member 'WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek, K2Node_CustomEvent_bIsGameInstallPending) == 0x0005C8, "Member 'WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek::K2Node_CustomEvent_bIsGameInstallPending' has a wrong offset!");
static_assert(offsetof(WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek, CallFunc_GetUIManager_ReturnValue_4) == 0x0005D0, "Member 'WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek::CallFunc_GetUIManager_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek, K2Node_CreateDelegate_OutputDelegate_3) == 0x0005D8, "Member 'WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek::K2Node_CreateDelegate_OutputDelegate_3' has a wrong offset!");
static_assert(offsetof(WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek, CallFunc_GetUIManager_ReturnValue_5) == 0x0005F0, "Member 'WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek::CallFunc_GetUIManager_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek, CallFunc_IsGameInstallPending_ReturnValue) == 0x0005F8, "Member 'WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek::CallFunc_IsGameInstallPending_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek, K2Node_Event_bInHasFocus) == 0x0005F9, "Member 'WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek::K2Node_Event_bInHasFocus' has a wrong offset!");
static_assert(offsetof(WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek, Temp_bool_Variable_3) == 0x0005FA, "Member 'WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek::Temp_bool_Variable_3' has a wrong offset!");
static_assert(offsetof(WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek, K2Node_Select_Default_3) == 0x000600, "Member 'WBP_MaskOfTheWeek_C_ExecuteUbergraph_WBP_MaskOfTheWeek::K2Node_Select_Default_3' has a wrong offset!");
...
{
public:
	struct FSBZStoreItemUIData                    InUpdatedStoreItemUIData;                          // 0x0000(0x00F0)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};
static_assert(alignof(WBP_MaskOfTheWeek_C_OnDataUpdated) == 0x000008, "Wrong alignment on WBP_MaskOfTheWeek_C_OnDataUpdated");
static_assert(sizeof(WBP_MaskOfTheWeek_C_OnDataUpdated) == 0x0000F0, "Wrong size on WBP_MaskOfTheWeek_C_OnDataUpdated");
