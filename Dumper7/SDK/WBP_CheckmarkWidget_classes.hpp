...
public:
	...
	FMulticastInlineDelegateProperty_             OnCheckChanged;                                    // 0x02B0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)

public:
	void OnCheckChanged__DelegateSignature(bool NewState);
