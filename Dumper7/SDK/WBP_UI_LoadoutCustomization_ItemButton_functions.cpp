...
// Parameters:
// class UObject*                          FocusedButton                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_UI_LoadoutCustomization_ItemButton_C::ButtonFocusedEvent__DelegateSignature(class UObject* FocusedButton)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_UI_LoadoutCustomization_ItemButton_C", "ButtonFocusedEvent__DelegateSignature");

	Params::WBP_UI_LoadoutCustomization_ItemButton_C_ButtonFocusedEvent__DelegateSignature Parms{};
