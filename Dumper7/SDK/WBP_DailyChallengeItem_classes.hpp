...
public:
	...
	FMulticastInlineDelegateProperty_             OnChallengeRerollPressedEvent;                     // 0x0430(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	void OnChallengeRerollPressedEvent__DelegateSignature(class UWBP_DailyChallengeItem_C* ChallengeButton);
