...
public:
	...
	EPD3AmmoState                                 K2Node_Event_NewState_1;                           // 0x0010(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_11[0x3];                                       // 0x0011(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         K2Node_Event_AmmoAddedCount;                       // 0x0014(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	EPD3AmmoState                                 K2Node_Event_NewState;                             // 0x002C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_IsDesignTime;                         // 0x002D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_2E[0x2];                                       // 0x002E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         K2Node_Event_AmmoLoadedChanged;                    // 0x0030(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus) == 0x000050, "Wrong size on WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus");
...
static_assert(offsetof(WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus, K2Node_Event_bIsEquippedNewValue) == 0x000004, "Member 'WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus::K2Node_Event_bIsEquippedNewValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus, CallFunc_GetDynamicMaterial_ReturnValue) == 0x000008, "Member 'WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus, K2Node_Event_NewState_1) == 0x000010, "Member 'WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus::K2Node_Event_NewState_1' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus, K2Node_Event_AmmoAddedCount) == 0x000014, "Member 'WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus::K2Node_Event_AmmoAddedCount' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus, CallFunc_Play2DSound_ReturnValue) == 0x000018, "Member 'WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus::CallFunc_Play2DSound_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus, CallFunc_PlayAnimationForward_ReturnValue) == 0x000020, "Member 'WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus::CallFunc_PlayAnimationForward_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus, K2Node_Event_AmmoInventoryChanged) == 0x000028, "Member 'WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus::K2Node_Event_AmmoInventoryChanged' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus, K2Node_Event_NewState) == 0x00002C, "Member 'WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus::K2Node_Event_NewState' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus, K2Node_Event_IsDesignTime) == 0x00002D, "Member 'WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus, K2Node_Event_AmmoLoadedChanged) == 0x000030, "Member 'WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus::K2Node_Event_AmmoLoadedChanged' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus, CallFunc_Add_IntInt_ReturnValue) == 0x000034, "Member 'WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus, CallFunc_Conv_IntToText_ReturnValue) == 0x000038, "Member 'WBP_UI_Widget_WeaponStatus_C_ExecuteUbergraph_WBP_UI_Widget_WeaponStatus::CallFunc_Conv_IntToText_ReturnValue' has a wrong offset!");
