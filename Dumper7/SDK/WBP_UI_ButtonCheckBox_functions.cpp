...
void UWBP_UI_ButtonCheckBox_C::OnCheckChanged__DelegateSignature(bool bNewState)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_UI_ButtonCheckBox_C", "OnCheckChanged__DelegateSignature");

	Params::WBP_UI_ButtonCheckBox_C_OnCheckChanged__DelegateSignature Parms{};
