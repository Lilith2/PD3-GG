...
namespace Offsets
{
	constexpr int32 GObjects          = 0x070E3AF0;
	constexpr int32 AppendString      = 0x019EDDC0;
	constexpr int32 GNames            = 0x0708BC40;
	constexpr int32 GWorld            = 0x072393E0;
	constexpr int32 ProcessEvent      = 0x01BE9420;
