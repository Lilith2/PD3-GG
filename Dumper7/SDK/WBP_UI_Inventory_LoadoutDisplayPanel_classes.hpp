...
public:
	...
	FMulticastInlineDelegateProperty_             OnButtonFocusChanged;                              // 0x0340(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             SkillButtonSelected;                               // 0x0350(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TArray<class USBZSkillData*>                  RT_Skills;                                         // 0x0360(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)

public:
	void OnButtonFocusChanged__DelegateSignature(class USBZMenuButton* Button, bool bIsFocused, ESBZInventoryEquipmentType ButtonType);
	void SkillButtonSelected__DelegateSignature();
...
static_assert(sizeof(UWBP_UI_Inventory_LoadoutDisplayPanel_C) == 0x000370, "Wrong size on UWBP_UI_Inventory_LoadoutDisplayPanel_C");
