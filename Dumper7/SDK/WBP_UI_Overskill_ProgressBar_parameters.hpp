...
public:
	...
	struct FSlateChildSize                        K2Node_MakeStruct_SlateChildSize_1;                // 0x0034(0x0008)(NoDestructor)
	struct FSlateChildSize                        K2Node_MakeStruct_SlateChildSize_2;                // 0x003C(0x0008)(NoDestructor)
	...
	struct FSlateChildSize                        K2Node_MakeStruct_SlateChildSize_3;                // 0x0048(0x0008)(NoDestructor)
...
static_assert(offsetof(WBP_UI_Overskill_ProgressBar_C_Set_Progress, CallFunc_NotEqual_FloatFloat_ReturnValue) == 0x000008, "Member 'WBP_UI_Overskill_ProgressBar_C_Set_Progress::CallFunc_NotEqual_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Overskill_ProgressBar_C_Set_Progress, CallFunc_Conv_FloatToText_ReturnValue) == 0x000010, "Member 'WBP_UI_Overskill_ProgressBar_C_Set_Progress::CallFunc_Conv_FloatToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Overskill_ProgressBar_C_Set_Progress, K2Node_MakeStruct_SlateChildSize) == 0x000028, "Member 'WBP_UI_Overskill_ProgressBar_C_Set_Progress::K2Node_MakeStruct_SlateChildSize' has a wrong offset!");
static_assert(offsetof(WBP_UI_Overskill_ProgressBar_C_Set_Progress, CallFunc_Subtract_FloatFloat_ReturnValue) == 0x000030, "Member 'WBP_UI_Overskill_ProgressBar_C_Set_Progress::CallFunc_Subtract_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Overskill_ProgressBar_C_Set_Progress, K2Node_MakeStruct_SlateChildSize_1) == 0x000034, "Member 'WBP_UI_Overskill_ProgressBar_C_Set_Progress::K2Node_MakeStruct_SlateChildSize_1' has a wrong offset!");
static_assert(offsetof(WBP_UI_Overskill_ProgressBar_C_Set_Progress, K2Node_MakeStruct_SlateChildSize_2) == 0x00003C, "Member 'WBP_UI_Overskill_ProgressBar_C_Set_Progress::K2Node_MakeStruct_SlateChildSize_2' has a wrong offset!");
static_assert(offsetof(WBP_UI_Overskill_ProgressBar_C_Set_Progress, CallFunc_Subtract_FloatFloat_ReturnValue_1) == 0x000044, "Member 'WBP_UI_Overskill_ProgressBar_C_Set_Progress::CallFunc_Subtract_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_UI_Overskill_ProgressBar_C_Set_Progress, K2Node_MakeStruct_SlateChildSize_3) == 0x000048, "Member 'WBP_UI_Overskill_ProgressBar_C_Set_Progress::K2Node_MakeStruct_SlateChildSize_3' has a wrong offset!");
