...
{
public:
	struct FGameplayEventData                     Payload;                                           // 0x0000(0x00B8)(Parm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(AbilityAsync_WaitGameplayEvent_EventReceivedDelegate__DelegateSignature) == 0x0000B8, "Wrong size on AbilityAsync_WaitGameplayEvent_EventReceivedDelegate__DelegateSignature");
...
{
public:
	TDelegate<void(class AActor* Target, const struct FGameplayTag& GameplayTag, struct FGameplayCueParameters& Parameters, EGameplayCueEvent Event)> InGameplayCueTrackHandler;                         // 0x0000(0x0014)(Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
};
