...
// Function BP_QRPhone.BP_QRPhone_C.OnInteractedComplete__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void ABP_QRPhone_C::OnInteractedComplete__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_QRPhone_C", "OnInteractedComplete__DelegateSignature");
