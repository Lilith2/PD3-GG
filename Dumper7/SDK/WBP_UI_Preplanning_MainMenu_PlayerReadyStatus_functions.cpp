...
// Function WBP_UI_Preplanning_MainMenu_PlayerReadyStatus.WBP_UI_Preplanning_MainMenu_PlayerReadyStatus_C.OnPlayerStatusRemoved__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void UWBP_UI_Preplanning_MainMenu_PlayerReadyStatus_C::OnPlayerStatusRemoved__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_UI_Preplanning_MainMenu_PlayerReadyStatus_C", "OnPlayerStatusRemoved__DelegateSignature");
...
// bool                                    HasPlayerStatus_0                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UWBP_UI_Preplanning_MainMenu_PlayerReadyStatus_C::OnPlayerStatusUpdating__DelegateSignature(const class FString& PlayerName, bool HasPlayerStatus_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_UI_Preplanning_MainMenu_PlayerReadyStatus_C", "OnPlayerStatusUpdating__DelegateSignature");

	Params::WBP_UI_Preplanning_MainMenu_PlayerReadyStatus_C_OnPlayerStatusUpdating__DelegateSignature Parms{};

	Parms.PlayerName = std::move(PlayerName);
	Parms.HasPlayerStatus_0 = HasPlayerStatus_0;
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FSBZLobbyCharacterInfoUi         InCharacter                                            (BlueprintVisible, BlueprintReadOnly, Parm)
