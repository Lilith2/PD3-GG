...
// 0x0000 (0x0030 - 0x0030)
class ISBZJSonSerializeVariablesInterface final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
...
static_assert(alignof(ISBZJSonSerializeVariablesInterface) == 0x000008, "Wrong alignment on ISBZJSonSerializeVariablesInterface");
static_assert(sizeof(ISBZJSonSerializeVariablesInterface) == 0x000030, "Wrong size on ISBZJSonSerializeVariablesInterface");
