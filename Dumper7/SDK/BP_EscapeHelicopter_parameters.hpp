...
public:
	...
	class UABP_Helicopter_C*                      K2Node_DynamicCast_AsABP_Helicopter;               // 0x00D8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x00E0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_E1[0x7];                                       // 0x00E1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class ASBZAerialVehicle*                      K2Node_CustomEvent_Vehicle;                        // 0x00E8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FName                                   K2Node_CustomEvent_State;                          // 0x00F0(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BP_EscapeHelicopter_C_ExecuteUbergraph_BP_EscapeHelicopter) == 0x000100, "Wrong size on BP_EscapeHelicopter_C_ExecuteUbergraph_BP_EscapeHelicopter");
...
static_assert(offsetof(BP_EscapeHelicopter_C_ExecuteUbergraph_BP_EscapeHelicopter, K2Node_DynamicCast_AsABP_Helicopter) == 0x0000D8, "Member 'BP_EscapeHelicopter_C_ExecuteUbergraph_BP_EscapeHelicopter::K2Node_DynamicCast_AsABP_Helicopter' has a wrong offset!");
static_assert(offsetof(BP_EscapeHelicopter_C_ExecuteUbergraph_BP_EscapeHelicopter, K2Node_DynamicCast_bSuccess) == 0x0000E0, "Member 'BP_EscapeHelicopter_C_ExecuteUbergraph_BP_EscapeHelicopter::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_EscapeHelicopter_C_ExecuteUbergraph_BP_EscapeHelicopter, K2Node_CustomEvent_Vehicle) == 0x0000E8, "Member 'BP_EscapeHelicopter_C_ExecuteUbergraph_BP_EscapeHelicopter::K2Node_CustomEvent_Vehicle' has a wrong offset!");
static_assert(offsetof(BP_EscapeHelicopter_C_ExecuteUbergraph_BP_EscapeHelicopter, K2Node_CustomEvent_State) == 0x0000F0, "Member 'BP_EscapeHelicopter_C_ExecuteUbergraph_BP_EscapeHelicopter::K2Node_CustomEvent_State' has a wrong offset!");
static_assert(offsetof(BP_EscapeHelicopter_C_ExecuteUbergraph_BP_EscapeHelicopter, CallFunc_IsDedicatedServer_ReturnValue) == 0x0000FC, "Member 'BP_EscapeHelicopter_C_ExecuteUbergraph_BP_EscapeHelicopter::CallFunc_IsDedicatedServer_ReturnValue' has a wrong offset!");
