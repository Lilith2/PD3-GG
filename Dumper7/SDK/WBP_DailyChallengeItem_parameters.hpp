...
// Function WBP_DailyChallengeItem.WBP_DailyChallengeItem_C.OnChallengeRerollPressedEvent__DelegateSignature
// 0x0008 (0x0008 - 0x0000)
struct WBP_DailyChallengeItem_C_OnChallengeRerollPressedEvent__DelegateSignature final
{
public:
...
static_assert(alignof(WBP_DailyChallengeItem_C_OnChallengeRerollPressedEvent__DelegateSignature) == 0x000008, "Wrong alignment on WBP_DailyChallengeItem_C_OnChallengeRerollPressedEvent__DelegateSignature");
static_assert(sizeof(WBP_DailyChallengeItem_C_OnChallengeRerollPressedEvent__DelegateSignature) == 0x000008, "Wrong size on WBP_DailyChallengeItem_C_OnChallengeRerollPressedEvent__DelegateSignature");
static_assert(offsetof(WBP_DailyChallengeItem_C_OnChallengeRerollPressedEvent__DelegateSignature, ChallengeButton) == 0x000000, "Member 'WBP_DailyChallengeItem_C_OnChallengeRerollPressedEvent__DelegateSignature::ChallengeButton' has a wrong offset!");
