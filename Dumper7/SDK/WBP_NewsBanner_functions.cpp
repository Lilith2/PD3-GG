...
// Function WBP_NewsBanner.WBP_NewsBanner_C.OnCarouselPressed__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void UWBP_NewsBanner_C::OnCarouselPressed__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_NewsBanner_C", "OnCarouselPressed__DelegateSignature");
...
// TArray<struct FSBZNewsDataUIEntry>      NewsFeedList                                           (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
