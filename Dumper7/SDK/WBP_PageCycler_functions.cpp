...
// Function WBP_PageCycler.WBP_PageCycler_C.NavigateToIndex__DelegateSignature
...
void UWBP_PageCycler_C::NavigateToIndex__DelegateSignature(int32 InNavigateIndex)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PageCycler_C", "NavigateToIndex__DelegateSignature");

	Params::WBP_PageCycler_C_NavigateToIndex__DelegateSignature Parms{};
...
// Function WBP_PageCycler.WBP_PageCycler_C.DecrementPageIndex__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void UWBP_PageCycler_C::DecrementPageIndex__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PageCycler_C", "DecrementPageIndex__DelegateSignature");

	UObject::ProcessEvent(Func, nullptr);
}


// Function WBP_PageCycler.WBP_PageCycler_C.IncrementPageIndex__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void UWBP_PageCycler_C::IncrementPageIndex__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PageCycler_C", "IncrementPageIndex__DelegateSignature");
