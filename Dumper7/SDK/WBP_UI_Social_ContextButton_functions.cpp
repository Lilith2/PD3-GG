...
// Function WBP_UI_Social_ContextButton.WBP_UI_Social_ContextButton_C.ContextButtonSelected__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void UWBP_UI_Social_ContextButton_C::ContextButtonSelected__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_UI_Social_ContextButton_C", "ContextButtonSelected__DelegateSignature");
