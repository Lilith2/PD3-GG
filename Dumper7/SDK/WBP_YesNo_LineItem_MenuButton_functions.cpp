...
// Parameters:
// class FText                             HeistTitle_0                                           (BlueprintVisible, BlueprintReadOnly, Parm)
// bool                                    IsHeistActive_0                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UWBP_YesNo_LineItem_MenuButton_C::OnHeistSettingUpdated__DelegateSignature(const class FText& HeistTitle_0, bool IsHeistActive_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_YesNo_LineItem_MenuButton_C", "OnHeistSettingUpdated__DelegateSignature");

	Params::WBP_YesNo_LineItem_MenuButton_C_OnHeistSettingUpdated__DelegateSignature Parms{};

	Parms.HeistTitle_0 = std::move(HeistTitle_0);
