...
public:
	...
	struct FSBZMaskInventorySlot                  CallFunc_GetMaskSlot_ReturnValue;                  // 0x0010(0x00C8)()
	struct FSBZMaskPartConfigGroup                CallFunc_Map_Find_Value;                           // 0x00D8(0x0010)(NoDestructor)
...
static_assert(sizeof(WBP_UI_Inventory_MaskSlotButton_C_Get_Mould_Mod_Data) == 0x0000F0, "Wrong size on WBP_UI_Inventory_MaskSlotButton_C_Get_Mould_Mod_Data");
...
static_assert(offsetof(WBP_UI_Inventory_MaskSlotButton_C_Get_Mould_Mod_Data, CallFunc_Map_Find_Value) == 0x0000D8, "Member 'WBP_UI_Inventory_MaskSlotButton_C_Get_Mould_Mod_Data::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_MaskSlotButton_C_Get_Mould_Mod_Data, CallFunc_Map_Find_ReturnValue) == 0x0000E8, "Member 'WBP_UI_Inventory_MaskSlotButton_C_Get_Mould_Mod_Data::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
...
public:
	...
	struct FSBZMaskInventorySlot                  CallFunc_GetMaskSlot_ReturnValue;                  // 0x0010(0x00C8)()
	const class USBZModularPartDataAsset*         CallFunc_Get_Mould_Mod_Data_Part;                  // 0x00D8(0x0008)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	const class USBZMaskData*                     CallFunc_GetMaskInSlot_ReturnValue;                // 0x00E0(0x0008)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class USBZInventoryBaseData*                  K2Node_Select_Default;                             // 0x00F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_UI_Inventory_MaskSlotButton_C_GetMaskMouldOrData) == 0x0000F8, "Wrong size on WBP_UI_Inventory_MaskSlotButton_C_GetMaskMouldOrData");
...
static_assert(offsetof(WBP_UI_Inventory_MaskSlotButton_C_GetMaskMouldOrData, CallFunc_Get_Mould_Mod_Data_Part) == 0x0000D8, "Member 'WBP_UI_Inventory_MaskSlotButton_C_GetMaskMouldOrData::CallFunc_Get_Mould_Mod_Data_Part' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_MaskSlotButton_C_GetMaskMouldOrData, CallFunc_GetMaskInSlot_ReturnValue) == 0x0000E0, "Member 'WBP_UI_Inventory_MaskSlotButton_C_GetMaskMouldOrData::CallFunc_GetMaskInSlot_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_MaskSlotButton_C_GetMaskMouldOrData, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x0000E8, "Member 'WBP_UI_Inventory_MaskSlotButton_C_GetMaskMouldOrData::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_MaskSlotButton_C_GetMaskMouldOrData, CallFunc_EqualEqual_ObjectObject_ReturnValue) == 0x0000E9, "Member 'WBP_UI_Inventory_MaskSlotButton_C_GetMaskMouldOrData::CallFunc_EqualEqual_ObjectObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_MaskSlotButton_C_GetMaskMouldOrData, CallFunc_EqualEqual_ByteByte_ReturnValue_1) == 0x0000EA, "Member 'WBP_UI_Inventory_MaskSlotButton_C_GetMaskMouldOrData::CallFunc_EqualEqual_ByteByte_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_MaskSlotButton_C_GetMaskMouldOrData, CallFunc_BooleanAND_ReturnValue) == 0x0000EB, "Member 'WBP_UI_Inventory_MaskSlotButton_C_GetMaskMouldOrData::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_MaskSlotButton_C_GetMaskMouldOrData, CallFunc_BooleanOR_ReturnValue) == 0x0000EC, "Member 'WBP_UI_Inventory_MaskSlotButton_C_GetMaskMouldOrData::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Inventory_MaskSlotButton_C_GetMaskMouldOrData, K2Node_Select_Default) == 0x0000F0, "Member 'WBP_UI_Inventory_MaskSlotButton_C_GetMaskMouldOrData::K2Node_Select_Default' has a wrong offset!");
