...
{
public:
	ESBZGateState                                 State_0;                                           // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(BP_interactableDoor_Base_C_GetDoorSimpleState, State_0) == 0x000000, "Member 'BP_interactableDoor_Base_C_GetDoorSimpleState::State_0' has a wrong offset!");
