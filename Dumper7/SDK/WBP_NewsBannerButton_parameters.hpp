...
// Function WBP_NewsBannerButton.WBP_NewsBannerButton_C.OnCarouselPageIndexChanged__DelegateSignature
// 0x0004 (0x0004 - 0x0000)
struct WBP_NewsBannerButton_C_OnCarouselPageIndexChanged__DelegateSignature final
{
public:
...
static_assert(alignof(WBP_NewsBannerButton_C_OnCarouselPageIndexChanged__DelegateSignature) == 0x000004, "Wrong alignment on WBP_NewsBannerButton_C_OnCarouselPageIndexChanged__DelegateSignature");
static_assert(sizeof(WBP_NewsBannerButton_C_OnCarouselPageIndexChanged__DelegateSignature) == 0x000004, "Wrong size on WBP_NewsBannerButton_C_OnCarouselPageIndexChanged__DelegateSignature");
static_assert(offsetof(WBP_NewsBannerButton_C_OnCarouselPageIndexChanged__DelegateSignature, NewIndex) == 0x000000, "Member 'WBP_NewsBannerButton_C_OnCarouselPageIndexChanged__DelegateSignature::NewIndex' has a wrong offset!");
